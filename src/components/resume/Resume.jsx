  ...
  return (
    <div className="resume">
      ...
      <section className="resumecontent">
        <p className="text-center mt-5">Download my <button className="resumebtn"><a className="resumelink" href="resume/Anna-Britta-Pincus.pdf" download>Resume</a></button></p>
